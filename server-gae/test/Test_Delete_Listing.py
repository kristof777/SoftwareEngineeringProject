...
class TestHandlers(unittest.TestCase):
    ...
    def setUp(self):
        ...
        res_value, status = get_like_response(get_like_post_dictionary(self.likerId, self.listingId, "True"))
    ...
    def test_listing_auth(self):
        ...
        res_value, status = get_delete_response(
            get_delete_post_dictionary(self.deleterId, self.listingId))
    ...
    def invalid_user_id(self):
        res_value, status = get_delete_response(get_delete_post_dictionary("blabla", "blabla"))
    ...
    def test_correct_input(self):
        res_value, status = get_delete_response(
            get_delete_post_dictionary(self.ownerId, self.listingId))
...
def get_delete_post_dictionary(userId, listingId):
    return {"userId": userId, "listingId":
        listingId}
